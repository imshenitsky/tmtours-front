				...
				<section class="section nav-section gray-section" id="2">
					<div class="center">
						...
						<ul class="product-list">
							<li>
								<a href="#" style="background-image:url(images/provider-product1.jpg);">
									<span class="expanded">
										<ul>
											<li>Тип номера - Standart sea side</li>
											<li>Тип питания - HB (завтрак и ужин)</li>
											<li>Город вылета - Харьков</li>
											<li>16.07.2017 на 8 ночей</li>
										</ul>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis velit minus ea, quibusdam iure, impedit</p>
									</span>
									<span class="order">Заказать</span>
									<div class="head">
										<span class="info-panel">
											<strong class="country">Турция</strong>
											<strong>Анталия</strong>
											<!-- <strong>16.07.2017 на 8 ночей</strong> -->
											<strong class="price">800$</strong>
										</span>
										<strong class="title">Fortuna 5*, Lorem ipsum dolor sit amet</strong>
									</div>
								</a>
							</li>
							<li>
								<a href="#" style="background-image:url(images/provider-product2.jpg);">
									<span class="expanded">
										<ul>
											<li>Тип номера - Standart sea side</li>
											<li>Тип питания - HB (завтрак и ужин)</li>
							...
							<li>
								<a href="#" style="background-image:url(images/provider-product3.jpg);">
									<span class="expanded">
										<ul>
											<li>Тип номера - Standart sea side</li>
											<li>Тип питания - HB (завтрак и ужин)</li>
							...
							<li>
								<a href="#" style="background-image:url(images/provider-product4.jpg);">
									<span class="expanded">
										<ul>
											<li>Тип номера - Standart sea side</li>
											<li>Тип питания - HB (завтрак и ужин)</li>
